          ...
          <div className="fixed inset-0 flex items-center justify-center z-[101] pointer-events-none p-4">
            ...
            >
              ...
              <div className="grid grid-cols-1 gap-3">
                <button className="flex items-center justify-center gap-2 bg-[#5865F2]/10 border border-[#5865F2]/20 py-2.5 rounded-xl hover:bg-[#5865F2]/20 hover:border-[#5865F2]/30 transition-all group opacity-50 cursor-not-allowed">
                  <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor" className="text-[#5865F2] group-hover:scale-110 transition-transform">
                  ...
                  <span className="text-[10px] font-bold text-white">Discord (Próximamente)</span>
                </button>
              </div>
